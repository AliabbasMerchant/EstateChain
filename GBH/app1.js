 function assetsOwner(img,name,type,l,rate,rentedto,rentedpri,rentedup,sell,rent)
{
	...
	for(var i=0;i<img.length;i++)
	{
		...
		str+="</span><span style=margin-right:40px;><label>Rent: </label><input type=text value="+rent[i]+" name=rent id=rent/></span><button type=button id=save class=\'btn btn-primary\'>Save</button>";
		str+="</form></div></div><hr>";
	}
	return str;
}
